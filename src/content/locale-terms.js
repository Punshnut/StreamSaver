...
const TERMS_BY_LOCALE = {
  ...
  de: {
    ...
    settingsLowLatency: ['niedrige latenz'],
  ...
  fr: {
    ...
    settingsLowLatency: ['faible latence'],
  ...
  es: {
    ...
    settingsLowLatency: ['latencia baja', 'baja latencia'],
  ...
  pt: {
    ...
    settingsLowLatency: ['baixa latência', 'baixa latencia'],
  ...
  it: {
    ...
    settingsLowLatency: ['bassa latenza'],
  ...
  ru: {
    ...
    settingsLowLatency: ['низкая задержка'],
  ...
  id: {
    ...
    settingsLowLatency: ['latensi rendah'],
    settingsClose:     ['tutup'],
  ...
  da: {
    ...
    settingsLowLatency: ['lav latenstid', 'lav ventetid'],
    settingsClose:     ['luk'],
  ...
  uk: {
    ...
    settingsLowLatency: ['низька затримка'],
